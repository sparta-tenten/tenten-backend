...
import com.sparta.tentenbackend.domain.menu.dto.MenuResponse;
...
public class MenuController {
    ...
    // 메뉴 생성
    @PostMapping("/{storeId}")
    public ResponseEntity<Menu> createMenu(@PathVariable UUID storeId,
    ...
    public ResponseEntity<Page<MenuDto>> searchMenus(
        ...
        Page<MenuDto> menus = menuService.searchMenus(storeId, keyword, sortBy, direction, page,
            size);
